...
namespace Mia\Calendar\Repository;

use \Illuminate\Database\Capsule\Manager as DB;

/**
 * Description of MiaAppointmentRepository
 *
 * @author matiascamiletti
 */
class MiaAppointmentRepository 
{
    /**
     * 
    ...
    {
        $query = \Mia\Calendar\Model\MiaAppointment::select('mia_appointment.*');
